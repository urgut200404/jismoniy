<template>
    <div>
        ...
        <div class="container mb-5 mt-5">
            <h4 class="text-center">Qiz Bolalar Uchun</h4>
            <div class="d-flex gap-2 justify-content-between route_Mash7_mx">
                ...
                <div class="ps-3 pt-4" style="width: 63%;">
                    ...
                    <div class="note-light p-3 rounded-2" v-show="fakultet_click == 'jism'">
                        <h4 class="text-center border-bottom pb-2">Qiz Bolalar uchun mashiqlar</h4>
                        ...
                        <div>
                            ...
                            <div class="border-top  mt-5 pt-3 text-center">
                                ...
                                <div class="mt-2">
                                    ...
                                    <div v-show="!placeholder_if0" class="w-100 mt-3">
                                        <iframe width="560" height="315"
                                            src="https://www.youtube.com/embed/lFwNVXC8Rrc?si=4_xeXuFwBu81hoCy&amp;controls=0"
                            ...
                            <div class="border-top  pt-5 text-center" style="margin-top: 100px;">
                                ...
                                <div class="mt-2">
                                    ...
                                    <div v-show="!placeholder_if1" class="w-100 mt-3">
                                        <iframe width="560" height="315"
                                            src="https://www.youtube.com/embed/2ZrjJUze5ls?si=f0h1wJIG93meBVOK"
                                            title="YouTube video player" frameborder="0"
                                            allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
                                            referrerpolicy="strict-origin-when-cross-origin" allowfullscreen
                            ...
                            <div class="border-top  pt-5 text-center" style="margin-top: 100px;">
                                ...
                                <div class="mt-2">
                                    ...
                                    <div v-show="!placeholder_if3" class="w-100 mt-4">
                                        <iframe width="560" height="315"
                                            src="https://www.youtube.com/embed/OrRu3cLS97o?si=mqm7cqKdt4Lkirqf"
                                            title="YouTube video player" frameborder="0"
                                            allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
